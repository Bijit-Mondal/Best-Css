...
function ShowResults(response){
 ...
 let template =  '<div class="card mySlides fade">'+
        '<h4>TITLE</h4>'+
        '<img src="THUMBNAIL_URL" alt="icon">'+
        '<div class="container-2">'+
            '<div>'+
                '<button class="download" onclick="DownloadVideo(`VIDEO_ID`,`TITLE`)">Video</button>'+
            '</div>'+
            '<div>'+
                '<button class="download1" onclick="DownloadAudio(`VIDEO_ID`,`TITLE`)">Audio</button>'+
            '</div>'+
        '</div>'+
    '</div>';
